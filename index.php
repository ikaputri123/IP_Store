                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="static-top-content mt-sm-30">
                            Promo Spesial Akhir Pekan dari <strong>IP Store</strong> – Gunakan Kode Kupon:
                            <span>ipstore bagi-bagi</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="li-static-home-content">
                            ...
                            <h2>Smartphone & Aksesoris IP Store</h2>
                            <p class="schedule">
                                Mulai dari
                                <span> Rp165.000</span>
                            </p>
